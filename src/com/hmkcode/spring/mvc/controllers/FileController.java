...
public class FileController {
	...
	/***************************************************
	 * URL: /rest/controller/uploadCrossDomain uploadCrossDomain(): receives
	 * files
	 * 
	 * @param request
	 *            : MultipartHttpServletRequest auto passed
	 ...
	 ****************************************************/
	@RequestMapping(value = "/uploadCrossDomain", method = RequestMethod.POST)
	public void uploadCrossDomain(MultipartHttpServletRequest request,
		...
		response.addHeader("Location", redirect + filesString);
		response.sendRedirect(redirect + filesString);
